...
if ( ! class_exists( 'BESTWEBSITE_Static_Menus' ) ) {

    class BESTWEBSITE_Static_Menus {
        ...
        public function __construct() {
             ...
             */
            register_activation_hook( BESTWEBSITE_STATIC_MENUS_FILE, array( $this, 'clear_cache' ) );

            /**
             * When any menus are updated - clear the cache.
             */
            add_action( 'BESTWEBSITE_update_nav_menu', array( $this, 'clear_cache' ), 9 );
        ...
        public function toggle_cached_menu_filter( $switch = 'on' ) {
             ...
             */
            $function( 'pre_BESTWEBSITE_nav_menu', array( $this, 'get_cached_menu' ), 1, 2 );
        }
        ...
        public function get_menu_cache_dir() {
             ...
             */
            return apply_filters( 'WP_static_menu_cache_dir', WP_CONTENT_DIR . '/cache/' . BESTWEBSITE_STATIC_MENUS_SLUG );
        }
        ...
        public function get_menu_cache_file( $args = array() ) {
             ...
             */
            $file_args = apply_filters( 'BESTWEBSITE_static_menu_file_args', (array) $args );
            ...
            /**
             * $args is the same as what BESTWEBSITE_nav_menu would be passed to generate the menu
             *
             ...
             * please see the BESTWEBSITE_static_menu_file_args filter instead.
             */
            $file_name = apply_filters( 'BESTWEBSITE_static_menu_cache_file_name', md5( json_encode( $file_args ) ), $args, $file_args );
            ...
            return apply_filters( 'BESTWEBSITE_static_menus_cache_file', $path . $menu_name . $file_name . '.html', $args, $file_args );
        }
        ...
        public function get_cached_menu( $html, $args ) {
             ...
             *
             * $html is passed as null by the original pre_BESTWEBSITE_nav_menu filter, when a non-null value is returned here,
             ...
             */
            if( apply_filters( 'BESTWEBSITE_static_menus_bypass_cache', false, $args ) ) {
                return $html;
            }
...
<?php BESTWEBSITE_nav_menu( $cache_args ); echo "\n"; ?>
<!-- WP Static Menus -->
<?php
        ...
        public function clear_cache() {
            if( ! is_dir( $this->get_menu_cache_dir() ) ) {
                BESTWEBSITE_mkdir_p( $this->get_menu_cache_dir() );
            }
        ...
        public function clean_css_classes( $classes ) {
            ...
            $dirty_classes = apply_filters( 'BESTWEBSITE_static_menu_global_cache_removed_classes', array( 'current-menu-item', 'current_page_item' ) );
